...
class Better_Shadow extends Widget_Base {
	...
	protected function render() {
	    ...
	    <div class="better-shadows">
	        <img class="shadow sh-left" src="<?php echo esc_url( plugins_url('/assets/img/shadow.png', dirname(__DIR__)) ); ?>" alt="">
	        <img class="shadow sh-right" src="<?php echo esc_url( plugins_url('/assets/img/shadow.png', dirname(__DIR__)) ); ?>" alt="">
	    </div>
