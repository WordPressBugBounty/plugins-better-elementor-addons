...
class Better_Price extends Widget_Base {
	...
	public function get_icon() {
		return 'eicon-posts-ticker bea-widget-badge';
	}
	...
	?>
	    <div class="better-price style-1">
	        <div class="price-title">
	            <h4><?php echo esc_html($settings['better_price_box_title']); ?></h4>
	        </div>
	        <div class="price-tag">
	            <h2><?php echo esc_html($settings['better_price_box_amount']); ?> <span><?php echo esc_html($settings['better_price_box_plan']); ?></span></h2>
	        </div>
	        <div class="price-item">
	            <ul>
	                ...
	                ?>
	                    <li class="price-area__item"><?php echo esc_html($item['better_price_box_features']); ?></li>
	                <?php
	                }
	                ?>
	            </ul>
	        ...
	        <a href="<?php echo esc_url($settings['better_price_box_button_link']['url']); ?>" class="box-btn"><?php echo esc_html($settings['better_price_box_button_text']); ?></a>
	    </div>
	<?php
	}
