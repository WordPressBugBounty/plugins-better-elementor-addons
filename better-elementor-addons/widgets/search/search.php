...
class Better_Header_Search extends Widget_Base {
	...
	public function get_icon() {
		return 'eicon-search bea-widget-badge';
	}
	...
	protected function render() {
	    $settings = $this->get_settings_for_display(); // Ensures compatibility with latest Elementor versions.
	    // Inline editing attributes for Elementor.
	    ...
	    <div class="better-header-search-icon hidden-xs hidden-sm">
	        <a class="search" href="#">
	            <?php \Elementor\Icons_Manager::render_icon($settings['search_icons'], ['aria-hidden' => 'true']); ?>
	        </a>
