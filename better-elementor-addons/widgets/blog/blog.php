...
class Better_Blog extends Widget_Base {
	...
	public function get_icon() {
		return 'eicon-post-list bea-widget-badge';
	}
	...
	protected function render() {
		...
		$allowed_styles = array('style1', 'style2', 'style3', 'style4', 'style5', 'style6', 'style7', 'style8', 'style9', 'style10'); // Add more styles as needed
