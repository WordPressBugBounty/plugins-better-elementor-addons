...
class Better_Menu_List extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'tabs_settting',
			[
				'label' => __( 'Tabs Setting', 'better-elementor-addons' ),
		...
		$this->add_control(
			'active_tab_color',
			[
				'label' => __( 'Active Tab Color', 'better-elementor-addons' ),
        ...
        $this->add_control(
			'tab_color',
			[
				'label' => __( 'Tab Color', 'better-elementor-addons' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
        ...
        $this->add_control(
			'tab_num_color',
			[
				'label' => __( 'Tab Number Color', 'better-elementor-addons' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
	...
	protected function render() {
		...
		$allowed_styles = array('1', '2', '3'); // Add more styles as needed
