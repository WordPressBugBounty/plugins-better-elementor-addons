	                    ...
	                    <div class="black-search-table-cell">
	                        <div>
	                            ...
	                            <form role="search" method="get" id="<?php echo esc_attr( $better_unique_id ); ?>" class="searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	                                <input type="search" class="focus-input" placeholder="<?php echo esc_attr__('Type search keyword...', 'better-elementor-addons'); ?>" value="<?php echo esc_attr( get_search_query() ); ?>" name="s">
